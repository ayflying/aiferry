...
func New(masterKey []byte) (*sSecret, error) {
	...
	return &sSecret{aead: aead}, nil
}

func (s *sSecret) Encrypt(plainText string) (string, error) {
...
func (s *sSecret) Decrypt(value string) (string, error) {
