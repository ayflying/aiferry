...
func (s *sChannel) saveCredentialCostResult(ctx context.Context, credentialID uint64, result CostResult) error {
...
func (s *sChannel) saveChannelCostResult(ctx context.Context, channelID uint64, result CostResult) error {
