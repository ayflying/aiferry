...
func (s *sChannel) readListCache(ctx context.Context) ([]View, bool) {
...
func (s *sChannel) writeListCache(ctx context.Context, views []View) {
	if s.app == nil || s.app.Redis == nil {
		return
	}
...
func (s *sChannel) InvalidateListCache(ctx context.Context) {
	if s.app != nil && s.app.Redis != nil {
		_ = s.app.Redis.Del(ctx, channelListCacheKey).Err()
	}
}
