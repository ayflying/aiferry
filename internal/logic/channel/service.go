...
func New(appSvc *app.Service, typeSvc *channeltype.Service, groupSvc *channelgroup.Service, resilienceSvc *system.Service, usageSvc *usage.Service, priceCache *pricingcache.Service, userSvc *user.Service, mailSvc *mailservice.Service) *sChannel {
	return &sChannel{app: appSvc, types: typeSvc, groups: groupSvc, resilience: resilienceSvc, usage: usageSvc, prices: priceCache, users: userSvc, mail: mailSvc}
}
...
func (s *sChannel) writableType(ctx context.Context, code string) (entity.ChannelTypes, channeltype.Config, error) {
...
func (s *sChannel) invalidateRoutes(ctx context.Context) error {
