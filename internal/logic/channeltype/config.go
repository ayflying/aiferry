...
func validCostAdapter(value string) bool {
	return value == AdapterNone || value == AdapterOpenAICosts || value == AdapterSub2API || value == AdapterNewAPI || value == AdapterCustomJSON || value == AdapterQiniuCosts || value == AdapterQiniuUsage
}
