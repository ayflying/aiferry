...
func New(ctx context.Context, client *http.Client, dataDir string) *sIPLocation {
	return newService(ctx, client, dataDir, defaultDatabases, databaseDownloadTimeout)
}

func newService(ctx context.Context, client *http.Client, dataDir string, databases []database, downloadTimeout time.Duration) *sIPLocation {
	if client == nil {
...
func (s *sIPLocation) downloadAndActivate(ctx context.Context, client *http.Client, dataDir string, databases []database, downloadTimeout time.Duration) {
...
func (s *sIPLocation) activate(ctx context.Context, paths []string) {
	if len(paths) != 2 {
...
func (s *sIPLocation) Lookup(value string) string {
