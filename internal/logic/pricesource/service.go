...
type sPriceSource struct {
	channels *channel.Service
}

func New(channelSvc *channel.Service) *sPriceSource {
	return &sPriceSource{channels: channelSvc}
}

func (s *sPriceSource) List(ctx context.Context) ([]View, error) {
...
func (s *sPriceSource) Create(ctx context.Context, input adminapi.PriceSourceInput) (uint64, error) {
...
func (s *sPriceSource) Update(ctx context.Context, id uint64, input adminapi.PriceSourceInput) error {
...
func (s *sPriceSource) Delete(ctx context.Context, id uint64) error {
	current, _, err := s.Get(ctx, id)
	if err != nil {
		return err
	}
...
func (s *sPriceSource) Sync(ctx context.Context, id uint64) (channel.PriceSyncResult, error) {
...
func (s *sPriceSource) Get(ctx context.Context, id uint64) (entity.PriceSources, Config, error) {
