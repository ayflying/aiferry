...
func (s *sSystem) GetMailSettings(ctx context.Context) (MailSettings, error) {
...
func (s *sSystem) UpdateMailSettings(ctx context.Context, input adminapi.MailSettingsInput) (MailSettings, error) {
...
func (s *sSystem) MailDeliverySettings(ctx context.Context) (MailDeliverySettings, error) {
	stored, err := s.loadStoredMailSettings(ctx)
	if err != nil {
...
func (s *sSystem) loadStoredMailSettings(ctx context.Context) (storedMailSettings, error) {
...
func (s *sSystem) saveMailSettings(ctx context.Context, value string) error {
