...
func (s *sSystem) UpdateSystemInformation(ctx context.Context, input adminapi.SystemInformationInput) (adminapi.SystemInformationInput, error) {
...
func (s *sSystem) ResolveSystemInformation(ctx context.Context, fallbackServerURL string) (adminapi.SystemInformationInput, error) {
...
func (s *sSystem) cacheSystemInformation(ctx context.Context, settings adminapi.SystemInformationInput) error {
	encoded, err := json.Marshal(settings)
	if err != nil {
		return err
	}
