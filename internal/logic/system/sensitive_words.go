...
func (s *sSystem) GetSensitiveWordSettings(ctx context.Context) (adminapi.SensitiveWordSettingsInput, error) {
...
func (s *sSystem) UpdateSensitiveWordSettings(ctx context.Context, input adminapi.SensitiveWordSettingsInput) (adminapi.SensitiveWordSettingsInput, error) {
...
func (s *sSystem) CheckSensitivePrompt(ctx context.Context, endpoint string, body []byte) error {
...
func (s *sSystem) cacheSensitiveWordSettings(ctx context.Context, settings adminapi.SensitiveWordSettingsInput) error {
	encoded, err := json.Marshal(settings)
	if err != nil {
		return err
	}
