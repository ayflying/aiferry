...
func (s *sSystem) DisableIfNeeded(ctx context.Context, input AutoDisableInput) (bool, error) {
...
func (s *sSystem) RecoverIfAllowed(ctx context.Context, channelID uint64) (bool, error) {
	settings, err := s.Get(ctx)
	if err != nil {
		return false, err
	}
...
func (s *sSystem) RecoverCredentialIfAllowed(ctx context.Context, credentialID uint64) (bool, error) {
	settings, err := s.Get(ctx)
	if err != nil {
		return false, err
	}
...
func (s *sSystem) clearTransient(ctx context.Context, channelID uint64) {
...
func (s *sSystem) clearCredentialTransient(ctx context.Context, credentialID uint64) {
