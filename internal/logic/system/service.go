...
func New(appSvc *app.Service) *sSystem {
	return &sSystem{app: appSvc}
}
...
func (s *sSystem) Get(ctx context.Context) (adminapi.SystemResilienceSettingsInput, error) {
...
func (s *sSystem) Update(ctx context.Context, input adminapi.SystemResilienceSettingsInput) (adminapi.SystemResilienceSettingsInput, error) {
...
func (s *sSystem) cache(ctx context.Context, settings adminapi.SystemResilienceSettingsInput) error {
	encoded, err := json.Marshal(settings)
	if err != nil {
		return err
	}
