...
func New() *sPricingCache {
	service := &sPricingCache{}
	service.snapshot.Store(snapshot{})
	return service
}

func (s *sPricingCache) Load(ctx context.Context) error {
...
func (s *sPricingCache) IsPriced(modelName string) bool {
...
func (s *sPricingCache) current() snapshot {
