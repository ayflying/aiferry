  ...
  <main class="home-page">
    ...
    <section class="home-hero" aria-labelledby="home-title">
      ...
      <div class="route-console" aria-label="模型路由示意图">
        ...
        <div class="console-lines" aria-hidden="true"><i /><i /><i /></div>
        ...
        <div class="console-lines console-lines-out" aria-hidden="true"><i /><i /><i /></div>
        <div class="console-destinations">
          <div class="destination destination-openai"><span class="destination-mark">O</span><span><b>GPT-4.1</b><small>优先路由</small></span><CircleCheck :size="17" /></div>
...
.route-console { position: relative; min-height: 470px; padding: 20px; overflow: hidden; border: 1px solid #aabfd5; border-radius: 7px; background: #fcfdff; box-shadow: 16px 18px 0 #d5e1ee; }.route-console::before { position: absolute; inset: 58px 20px 56px; border: 1px dashed #cfdae7; content: ''; pointer-events: none; }.console-topline, .console-request, .console-footer { position: relative; z-index: 1; display: flex; align-items: center; justify-content: space-between; }.console-topline { color: #60788d; font-family: 'JetBrains Mono', monospace; font-size: 10px; }.console-live { display: inline-flex; align-items: center; gap: 6px; color: #2474b2; }.console-live i, .console-footer i { width: 7px; height: 7px; border-radius: 50%; background: #2b84c0; }.console-request { margin: 26px auto 0; padding: 12px 14px; border: 1px solid #c0cedd; border-radius: 4px; background: #fff; box-shadow: 0 5px 12px rgb(33 73 112 / 7%); color: #35536d; font-family: 'JetBrains Mono', monospace; font-size: 11px; }.console-request b { color: #256ca7; font-weight: 600; }.console-dot { width: 8px; height: 8px; border-radius: 50%; background: #e87651; }.console-lines { position: absolute; top: 118px; bottom: 150px; left: 31%; display: flex; width: 26%; flex-direction: column; justify-content: space-around; }.console-lines i { width: 100%; height: 1px; background: #9eb7d2; transform-origin: left center; }.console-lines i:nth-child(1) { transform: rotate(27deg); }.console-lines i:nth-child(3) { transform: rotate(-27deg); }.console-router { position: absolute; top: 50%; left: 29%; z-index: 1; display: grid; width: 70px; height: 70px; place-items: center; border: 1px solid #78a7ce; border-radius: 50%; background: #e7f0fa; box-shadow: 0 0 0 10px #f4f8fd; transform: translateY(-24%); }.console-router img { width: 42px; height: 42px; object-fit: contain; }.router-orbit { position: absolute; border-radius: 50%; border: 1px solid #88b4dc; }.orbit-a { inset: -8px; border-right-color: transparent; transform: rotate(-20deg); }.orbit-b { inset: -15px; border-left-color: transparent; opacity: .55; transform: rotate(40deg); }.console-lines-out { right: 27%; left: auto; }.console-lines-out i { transform-origin: right center; }.console-lines-out i:nth-child(1) { transform: rotate(-27deg); }.console-lines-out i:nth-child(3) { transform: rotate(27deg); }.console-destinations { position: absolute; top: 105px; right: 24px; z-index: 2; display: grid; gap: 13px; }.destination { display: flex; width: 188px; align-items: center; gap: 10px; padding: 10px; border: 1px solid #c9d5e3; border-radius: 4px; background: #fff; box-shadow: 0 4px 10px rgb(33 73 112 / 5%); }.destination > span:nth-child(2) { display: grid; flex: 1; gap: 2px; }.destination b { color: #1d405e; font-size: 12px; }.destination small { color: #718597; font-size: 10px; }.destination > svg { color: #277abb; }.destination-mark { display: grid; width: 25px; height: 25px; place-items: center; border-radius: 4px; font-family: 'JetBrains Mono', monospace; font-size: 12px; font-weight: 700; }.destination-openai .destination-mark { color: #236da8; background: #e6f0fa; }.destination-anthropic .destination-mark { color: #a75538; background: #fbe9e2; }.destination-local .destination-mark { color: #3263aa; background: #e5edfb; }.console-footer { position: absolute; right: 20px; bottom: 17px; left: 20px; padding-top: 14px; border-top: 1px solid #d9e3ee; color: #6a8092; font-family: 'JetBrains Mono', monospace; font-size: 10px; }.console-footer span { display: flex; align-items: center; gap: 6px; }
