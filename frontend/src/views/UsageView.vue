  ...
  <div class="page-stack">
    ...
    <div class="table-panel">
      <ResponsiveList>
        ...
        <el-table-column :label="isAdmin ? '渠道 / 密钥' : '访问密钥'" min-width="150"><template #default="{ row }"><ChannelCredentialDisplay v-if="isAdmin" class="request-cell" :channel-name="row.channelName" :credential-index="row.channelCredentialIndex" /><div v-else class="request-cell"><span>{{ row.apiKeyName || '—' }}</span></div></template></el-table-column>
