...
const managementKeyHint = computed(() => {
  ...
  return usesManagementKey.value
    ? '当前渠道类型的用量接口使用管理密钥鉴权'
    : '用于上游用量/余额等管理接口，当前类型未声明时可留空'
})
