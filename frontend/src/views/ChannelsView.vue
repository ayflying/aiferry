...
// showsChannelManagementKey：渠道表单是否保留"渠道管理密钥"输入。
// 管理密钥已统一到上游密钥抽屉按凭证维护，仅火山 AFP 这类需要渠道级
